...
int xmss_seed_keypair(unsigned char *pk, unsigned char *sk, const uint32_t oid, unsigned char *seed)
{
    xmss_params params;
    unsigned int i;
    ...
    return xmss_core_seed_keypair(&params, pk + XMSS_OID_LEN, sk + XMSS_OID_LEN, seed);
}
...
int xmssmt_seed_keypair(unsigned char *pk, unsigned char *sk, const uint32_t oid, unsigned char *seed)
{
    xmss_params params;
    unsigned int i;
    ...
    return xmssmt_core_seed_keypair(&params, pk + XMSS_OID_LEN, sk + XMSS_OID_LEN, seed);
}
